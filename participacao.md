...
| altair_data_transformation.ipynb      | Tradução 3.1         | 3.1 |   Herivelton Siqueira    |
...
| Nome do Arquivo     | Descrição                    | Item   | Participante       |
|---------------------|-----------------------------|--------|------------------|
|intro.md      | Revisão Introdução do site VC+I             |VC+I  |     |
|intro.md      | Revisão Introdução do site GS             |GS  |    |
|intro.md      | Revisão Introdução do site LI      |LI  |    |
|intro.md      | Revisão Introdução do site Creditos           |Creditos  |  |
|      |              |  |     |
| altair_marks_encoding.ipynb      | Revisão 2         | 2 |  |
| altair_marks_encoding.ipynb      | Revisão 2.1         | 2.1 |     |
| altair_marks_encoding.ipynb      | Revisão 2.2         | 2.2 |      |
